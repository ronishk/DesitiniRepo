...
#ifndef DESTINI_IOS13_SWIFT_H
#define DESTINI_IOS13_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Destini_iOS13",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13Destini_iOS1311AppDelegate")
...
SWIFT_CLASS("_TtC13Destini_iOS1313SceneDelegate")
...
SWIFT_CLASS("_TtC13Destini_iOS1314ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified storyLabel;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified choice1Button;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified choice2Button;
- (void)viewDidLoad;
- (IBAction)choiceButtonPressed:(UIButton * _Nonnull)sender;
